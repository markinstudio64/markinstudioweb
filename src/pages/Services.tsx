...
export const Services = ({ setActivePage }: ServicesProps) => {
  const serviceBlocks = [
    {
      ...
      icon: <Target className="text-violet-600" size={32} />
    },
    {
  ...
  const startupServiceBlock = {
    ...
    icon: <BarChart className="text-violet-600" size={32} />
  };
  ...
  return (
    <div className="bg-white bg-grid text-zinc-900 selection:bg-violet-600 selection:text-white pt-48 pb-32 relative overflow-hidden">
      {/* Background gradients */}
      <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[60%] bg-violet-50/50 rounded-full blur-3xl opacity-60 pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-5%] w-[30%] h-[50%] bg-blue-50/50 rounded-full blur-3xl opacity-60 pointer-events-none" />
      <div className="absolute top-[20%] left-[10%] w-[600px] h-[600px] bg-fuchsia-50/30 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <section className="mb-48">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <span className="text-violet-600 font-bold uppercase tracking-[0.5em] text-[10px] block mb-12">Capabilities</span>
            <h1 className="text-[clamp(4rem,12vw,10rem)] font-black uppercase tracking-tighter italic leading-[0.8] mb-12">
              Our <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-300 to-zinc-400 italic">Armoury.</span>
            </h1>
            <p className="text-2xl md:text-4xl font-medium tracking-tight text-zinc-500 leading-tight">
            ...
            >
              <div className="lg:col-span-5">
                <div className="mb-12 flex items-center gap-6">
                  ...
                  <span className="text-zinc-400 font-mono text-xl">/0{i + 1}</span>
                </div>
                <h2 className="text-4xl md:text-6xl font-black uppercase italic tracking-tighter leading-none mb-8">{block.title}</h2>
                <p className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-indigo-600 font-bold uppercase tracking-widest text-xs mb-12">{block.subtitle}</p>
              ...
              <div className="lg:col-span-7 pt-12 lg:pt-32">
                <div className="grid md:grid-cols-2 gap-8">
                  {block.features.map((feature, idx) => (
                    <div key={idx} className="group p-8 border border-zinc-200 rounded-3xl hover:bg-zinc-50 transition-colors">
                      <div className="flex justify-between items-center mb-4">
                        <h4 className="text-lg font-black uppercase italic group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-violet-600 group-hover:to-indigo-600 transition-colors">{feature}</h4>
                        <Plus size={16} className="text-zinc-400 group-hover:text-violet-600 transition-colors" />
                      </div>
                      <div className="h-1 w-0 bg-gradient-to-r from-violet-600 to-indigo-600 group-hover:w-full transition-all duration-500" />
                    </div>
                  ))}
                </div>

                <div className="mt-24 p-12 bg-zinc-50 rounded-[3rem] border border-zinc-100">
                  <h5 className="text-[10px] font-black uppercase tracking-widest text-zinc-400 mb-8">Selected Tech Stack</h5>
                  <div className="flex flex-wrap gap-8 opacity-40">
                    {["Vite", "OpenAI", "PyTorch", "Tailwind", "Motion", "Figma"].map(tech => (
                      <span key={tech} className="text-sm font-bold uppercase tracking-widest text-zinc-600">{tech}</span>
                    ))}
                  </div>
                </div>
              </div>
          ...
          >
            <div className="lg:col-span-5">
              <div className="mb-12 flex items-center gap-6">
                ...
                <span className="text-zinc-400 font-mono text-xl">/0{serviceBlocks.length + 1}</span>
              </div>
              ...
              <p className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-indigo-600 font-bold uppercase tracking-widest text-xs mb-12">{startupServiceBlock.subtitle}</p>
            ...
            <div className="lg:col-span-7 pt-12 lg:pt-32">
              ...
              <div className="mt-24 p-12 bg-zinc-50 rounded-[3rem] border border-zinc-100">
                <h5 className="text-[10px] font-black uppercase tracking-widest text-zinc-400 mb-8">Business Growth Stack</h5>
                <div className="flex flex-wrap gap-8 opacity-40">
          ...
          >
            <div className="lg:col-span-5">
              <div className="mb-12 flex items-center gap-6">
                ...
                <span className="text-zinc-400 font-mono text-xl">/0{serviceBlocks.length + 2}</span>
              </div>
              ...
              <p className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-indigo-600 font-bold uppercase tracking-widest text-xs mb-12">{consultancyServiceBlock.subtitle}</p>
            ...
            <div className="lg:col-span-7 pt-12 lg:pt-32">
              ...
              <div className="mt-24 p-12 bg-zinc-50 rounded-[3rem] border border-zinc-100">
                <h5 className="text-[10px] font-black uppercase tracking-widest text-zinc-400 mb-8">Consultancy Stack</h5>
                <div className="flex flex-wrap gap-8 opacity-40">
        ...
        <section className="mt-64 py-32 border-y border-zinc-100">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-black uppercase italic tracking-tighter mb-24 text-center">Frequently <br /> <span className="text-zinc-300">Asked.</span></h2>
            <div className="space-y-4">
              {[
                ...
                <details key={i} className="group border-b border-zinc-200 pb-8">
                  <summary className="list-none cursor-pointer flex justify-between items-center py-8">
                    <h4 className="text-2xl font-black uppercase italic tracking-tighter hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-violet-600 hover:to-indigo-600 transition-colors">{item.q}</h4>
        ...
        <section className="mt-64 text-center">
          ...
          <button
            ...
            className="h-32 w-32 rounded-full bg-black text-white flex items-center justify-center mx-auto hover:bg-gradient-to-r hover:from-violet-600 hover:to-indigo-600 transition-all group cursor-pointer shadow-xl"
          >
