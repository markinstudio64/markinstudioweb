      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-32 gap-12">
          ...
          <div className="flex flex-col items-end">
            <span className="text-6xl font-black italic text-zinc-300 mb-4">/140+</span>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center border-y border-zinc-100 py-8 mb-24 gap-8">
          <div className="flex flex-wrap gap-4">
            {categories.map(cat => (
              <button
                ...
                className={`px-6 py-2 rounded-full text-[10px] font-black uppercase tracking-widest transition-all ${filter === cat ? "bg-gradient-to-r from-violet-600 to-indigo-600 text-white" : "text-zinc-400 hover:text-violet-600"
                  }`}
              >
                {cat}
              </button>
          ...
          <div className="flex gap-4 items-center">
            <button
              ...
              className={`p-2 transition-colors ${view === 'grid' ? 'text-violet-600' : 'text-zinc-300'}`}
            >
              <Grid size={20} />
            </button>
            <button
              onClick={() => setView("list")}
              className={`p-2 transition-colors ${view === 'list' ? 'text-violet-600' : 'text-zinc-300'}`}
            >
              <List size={20} />
            </button>
                ...
                {filteredProjects.map((p, i) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center px-4">
                      <div>
                        <h3 className="text-2xl font-black uppercase italic tracking-tighter mb-1 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-violet-600 group-hover:to-indigo-600 transition-colors">{p.title}</h3>
                ...
                {filteredProjects.map((p, i) => (
                  ...
                  >
                    <div className="flex items-center gap-12">
                      ...
                      <h3 className="text-4xl md:text-7xl font-black uppercase italic tracking-tighter group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-violet-600 group-hover:to-indigo-600 transition-colors">{p.title}</h3>
                    </div>
