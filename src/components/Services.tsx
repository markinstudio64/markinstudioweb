...
const services = [
  {
    icon: <Palette className="text-violet-600" size={32} />,
  ...
  {
    icon: <BrainCircuit className="text-violet-600" size={32} />,
    title: "AI Automation",
  ...
  {
    icon: <Rocket className="text-violet-600" size={32} />,
    ...
    <section id="services" className="py-24 bg-zinc-50">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-sm font-bold tracking-widest text-violet-600 uppercase mb-4">Our Expertise</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-white p-8 rounded-3xl border border-zinc-100 hover:border-violet-200 transition-all hover:shadow-xl group"
            >
              <div className="mb-6 p-4 bg-zinc-50 rounded-2xl w-fit group-hover:bg-violet-50 transition-colors">
                {service.icon}
              </div>
